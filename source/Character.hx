...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'shovel':
				tex = Paths.getSparrowAtlas('mix/shovel/assets/shovel');
				frames = tex;
				...
				addOffset('idle');
				addOffset("singUP", 17, 8);
				addOffset("singRIGHT", 0, -3);
				addOffset("singLEFT", 60, -13);
				addOffset("singDOWN", 0, -17);

				playAnim('idle');

			case 'shantae':
				tex = Paths.getSparrowAtlas('mix/shantae/assets/shantae');
				frames = tex;
				animation.addByPrefix('idle', 'idle', 24);
				animation.addByPrefix('singUP', 'up', 24);
				animation.addByPrefix('singRIGHT', 'right', 24);
				...
				addOffset('idle');
				addOffset("singUP", -21, 78);
				addOffset("singRIGHT", -27, 48);
				addOffset("singLEFT", -20, 57);
				addOffset("singDOWN", -50, -67);
